pub struct MergeSortIterator<'a, T, I>
where
    I: Iterator<Item = &'a T>,
    T:'a
{
...
impl<'a, T, I> MergeSortIterator<'a, T, I>
where
    I: Iterator<Item = &'a T>,
    T: 'a
{
...
impl<'a, T, I> Iterator for MergeSortIterator<'a, T, I>
where
    I: Iterator<Item =  &'a T>,
    T: PartialOrd,
    T:'a
...
#[cfg(test)]
mod tests {
    use crate::merge_sort_iterator::MergeSortIterator;
    ...
    fn it_works() {
        ...
        let mut zip = MergeSortIterator::new(&a, &b);
